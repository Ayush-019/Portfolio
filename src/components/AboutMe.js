  ...
  return (
    <div className="about-container" id={id}>
      <div className="aboutMe-text">
        ...
        <span>(B.Tech + M.Tech) dual degree in Information Technology</span> at
        IIIT Gwalior. My coding journey began in 2020 upon entering the college
        and since then I've been actively engaged in
